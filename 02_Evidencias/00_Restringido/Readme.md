...
| `evidencias_restringidas.7z.001-007` | [Contenido de la entrega anterior — pendiente de documentar por el resto del equipo] |
...
## Cómo verificar (para el docente)

```powershell
7z x evidencias_P03aP16.7z.001 -p<contraseña>
