[saturacion_reporte.md](https://github.com/user-attachments/files/32117299/saturacion_reporte.md)
# Verificación de saturación temática

- Total de códigos axiales: 50
- Promedio de códigos nuevos en las últimas 3 entrevistas (P14, P15, P16): 1.33
- Porcentaje del acumulado final: 2.67%
- Umbral de saturación: 5%
- ¿Se sostiene la saturación? Sí
